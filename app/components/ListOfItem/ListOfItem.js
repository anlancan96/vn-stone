                                        ...
                                        <li className="product type-product">
                                            <div className="card card-product">
                                                <div className="card-image">
                                                    <a>
                                                    <img style={{width:'230px',height:'350px'}} src="../image/China/Indian White 1.jpg" className="attachment-hestia-shop size-hestia-show"/>
                                                    </a>
                                                </div>
                                                <div className="content">
                                                    <h6 className="category"><a>Granite</a></h6>
                                                    <h4 className="card-title">
                                                        <a className="shop-item-title-link">Indian White 1</a>
                                                    </h4>
